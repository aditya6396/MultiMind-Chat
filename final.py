...
def display_code(file):
    ...
    st.code(code, language=file.name.split('.')[-1])
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader("Choose your file", type=["pdf", "txt", "json", "csv", "jpg", "jpeg", "png", "gif", "py", "js", "java", "cpp", "c", "html", "css"])
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    if os.path.exists(temp_dir):
                        loader = SimpleDirectoryReader(
                            input_dir=temp_dir,
                            required_exts=[".pdf", ".txt", ".json", ".csv", ".jpg", ".jpeg", ".png", ".gif", ".py", ".js", ".java", ".cpp", ".c", ".html", ".css"],
                            recursive=True
                        )
                    else:
